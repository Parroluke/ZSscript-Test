import { Block, BlockInventoryComponentContainer, BlockLocation, EntityInventoryComponent, world } from "@minecraft/server";
...
world.events.beforeChat.subscribe((data)=>{
    let itemblock: Block = world.getDimension('overworld').getBlock(new BlockLocation(0,312,0));
    let chest;
    ...
    if(data.message.startsWith(prefix+"s ")) {
        ...
        if(num instanceof Number) {
            ...
            chest = <EntityInventoryComponent>itemblock.getComponent(`inventory`);
